...
!
    function (n) {
        ...
        function h() {
            return "/images/img/img (" + d(0, 1012) + ").jpeg";
        }
        function v(n, e, t, r) {
            n.beginPath(),
                n.moveTo(e, t),
        ...
        var m = function () {
            ...
            },
            {
                ...
                value: function () {
                    // 随机创建滑块的位置
                    var img_x = d(u + 10, o - (u + 10));
                    var img_y = d(10 + 2 * c, s - (u + 10));
                    console.log('img_x', img_x)
                    console.log('img_y', img_y)
                    if (parseInt(img_x) > 0 && parseInt(img_y)) {
                        setCookie("img_x", img_x, 0);
                        setCookie("img_y", img_y, 0);
                        this.x = img_x;
                        this.y = img_y;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_IntegrateRedemptionList.aspx.cs" Inherits="Web.admin.Admin_IntegrateRedemptionList" %>
                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <!--begin::Body-->
                                <div class="card-body">
                                    <div class="mb-6 ">
                                        <label class="form-label">权益码<span>*</span></label>
                                        <asp:TextBox ID="codestr" TextMode="SingleLine" runat="server" CssClass="txt form-control" autocomplete="off" reg="^.+$" tip="不能为空"></asp:TextBox>
                                    </div>
                                </div>
                            <!--end::Body-->
                            <!--begin::Footer-->

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_DataImgInfo.aspx.cs" Inherits="Web.admin.Admin_DataImgInfo" %>
                        ...
                        <div class="card card-primary card-outline mb-4">
                           ...
                           <div class="card-body">
                            ...
                            <div class="card-body">
                             ...
                             <div class="card-body">
                                <div class="mb-6">
                                    <label class="form-label">发布时间<span>*</span></label>
                                    <div class="layui-input-inline">
                                        <asp:TextBox ID="datetime" TextMode="SingleLine" runat="server" CssClass="txt form-control" reg="^.+$" tip="不能为空"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card mb-12">
                       <div class="card-header cardList">
                            <div class="cardItem">
                                <span>所属栏目：<span style="color: #f8ac59; margin-right: 50px;"><%=CommonFunc.GetTbClassModelUrl(tbclass_id.ToString())%></span> </span>
                            </div>
                        </div>
                        <div class="card-header cardList">
                            <div class="cardItem">
                            ...
                            <div class="cardItem" style="float: right;">
                                <a href="?Action=Add&MenuId=<%=MenuId %>&tbclass_id=<%=tbclass_id %>&BackURL=<%=Function.GetEncodeURL()%>" class="btn btn-primary">添加</a>
                            </div>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <itemtemplate>
                                            <tr class="hover">
                                                ...
                                                <td><%#CommonFunc.GetTbClassNameFunc(Eval("tbclass_id").ToString())%></td>
                                                 <td>
                                                ...
                                                <td class="textAlignC">
                                                    <img class="img_show" style="width: 14px; height: 14px; margin-top: 6px;" src="<%#Function.GetAdminIsShow(Eval("isshow").ToString(),"1")%>"
                                                        id='isshow<%#Eval("id")%>' border="0" style="cursor: pointer;" onclick="IsYes(<%#Eval("id")%>,'isshow','data_list')" />
                                                </td>
                                                <td class="textAlignC">
                                                    <img class="img_show" style="width: 14px; height: 14px; margin-top: 6px;" src="<%#Function.GetAdminIsShow(Eval("istop").ToString(),"1")%>"
                                                        id='istop<%#Eval("id")%>' border="0" style="cursor: pointer;" onclick="IsYes(<%#Eval("id")%>,'istop','data_list')" />
                                                </td>
                                                <td class="textAlignC">
                                                    ...
                                                    <div id='orderid_1_<%#Eval("id")%>' style="display: none;">
                                                        ...
                                                        <input type="button" class="btn btn-primary textAlignB" value="修改" onclick="$('td22<%#Eval("id")%>    ').hide();$('orderid_1_<%#Eval("id")%>').show();UpdateOrder(<%#Eval("id")%>, 'orderid', 'data_list', $('#orderid_3_<%#Eval("id")%>').val());" />
                                                    </div>
                                                </td>
                                                <td >
                                                     <a class="badge text-bg-success" href='?Action=Edit&MenuId=<%#MenuId %>&tbclass_id=<%#tbclass_id %>&ID=<%#Eval("id")%>&BackURL=<%=Function.GetEncodeURL() %>'>编辑</a>
                                                    <a class="badge text-bg-danger" data-href='?Action=Del&MenuId=<%#MenuId %>&tbclass_id=<%#tbclass_id %>&ID=<%#Eval("id")%>&BackURL=<%=Function.GetEncodeURL() %>' onclick="DataDelFunc(this)">删除</a>
                                                </td>
                                            </tr>
                                        </itemtemplate>
                                    </asp:Repeater>

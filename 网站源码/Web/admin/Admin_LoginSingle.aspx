<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_LoginSingle.aspx.cs" Inherits="Web.admin.Admin_LoginSingle" %>
                                            ...
                                            <tr class="hover">
                                                ...
                                                <td class="textAlignC">
                                                    <img class="img_show" style="width: 14px; height: 14px; margin-top: 6px;" src="<%#Function.GetAdminIsShow(Eval("IsShow").ToString(),"1")%>"
                                                        id='isshow<%#Eval("Id")%>' border="0" style="cursor: pointer;" onclick="IsYes(<%#Eval("Id")%>,'isshow','LoginSingle_List')" />
                                                </td>
                                                <td class="textAlignC">
                                                    ...
                                                    <div id='orderid_1_<%#Eval("Id")%>' style="display: none;">
                                                        ...
                                                        <input type="button" class="btn btn-primary textAlignB" value="修改" onclick="$('td22<%#Eval("Id")%>    ').hide();$('orderid_1_<%#Eval("Id")%>').show();UpdateOrder(<%#Eval("Id")%>, 'orderid', 'LoginSingle_List', $('#orderid_3_<%#Eval("Id")%>').val());" />
                                                    </div>
                                                </td>
                                                <td >

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_DaoRuInfo.aspx.cs" Inherits="Web.admin.Admin_DaoRuInfo" %>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <itemtemplate>
                                            <tr class="hover">
                                                ...
                                                <td><%#Function.HtmlDiscodeWeb(Eval("filename").ToString())%></td>
                                            </tr>
                                        </itemtemplate>
                                    </asp:Repeater>

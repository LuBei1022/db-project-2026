<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_JournalList.aspx.cs" Inherits="Web.admin.Admin_JournalList" CodePage="65001" %>
<!DOCTYPE html>
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="master-title">
                <div>
                    <h1>&#26399;&#21002;&#31649;&#29702;</h1>
                    <p>&#32479;&#19968;&#31649;&#29702;&#26399;&#21002;&#20027;&#25968;&#25454;&#65292;&#24182;&#29992;&#20110;&#35770;&#25991;&#26399;&#21002;&#20851;&#32852;&#12290;</p>
                </div>
                <div class="master-actions">
                    <a href="Admin_JournalList.aspx?Action=Add&MenuId=<%=MenuId %>">&#26032;&#22686;&#26399;&#21002;</a>
                </div>
            </div>
            <% if (IsEditMode) { %>
            <div class="card">
                <form method="post" action="Admin_JournalList.aspx?Action=<%=Server.UrlEncode(Action) %>&ID=<%=Id %>&MenuId=<%=Server.UrlEncode(MenuId) %>">
                    <div class="master-form">
                        ...
                        <div class="master-grid">
                            ...
                            <div class="master-field"><label>ISSN</label><input type="text" name="issn" value="<%=Server.HtmlEncode(Issn) %>" /></div>
                            <div class="master-field"><label>eISSN</label><input type="text" name="eissn" value="<%=Server.HtmlEncode(Eissn) %>" /></div>
                            <div class="master-field"><label>&#20986;&#29256;&#31038;</label><input type="text" name="publisher" value="<%=Server.HtmlEncode(Publisher) %>" /></div>
                            <div class="master-field"><label>&#22269;&#23478;/&#22320;&#21306;</label><input type="text" name="country" value="<%=Server.HtmlEncode(Country) %>" /></div>
                            <div class="master-field"><label>&#23398;&#31185;</label><input type="text" name="subject" value="<%=Server.HtmlEncode(Subject) %>" /></div>
                    ...
                    <div class="card-footer master-actions">
                        ...
                        <a href="Admin_JournalList.aspx?MenuId=<%=Server.UrlEncode(MenuId) %>">&#36820;&#22238;</a>
                    </div>
                </form>
            </div>
            <% } else { %>
            <div class="card mb-12">
                <form method="get" action="Admin_JournalList.aspx">
                    <input type="hidden" name="MenuId" value="<%=Server.HtmlEncode(MenuId) %>" />
                    <div class="master-toolbar">
                        <label>&#20851;&#38190;&#35789;</label>
                        <input type="text" name="Key" value="<%=Server.HtmlEncode(Key) %>" placeholder="&#26399;&#21002;&#21517;&#31216;&#12289;ISSN&#12289;&#20986;&#29256;&#31038;" />
                        <button type="submit" class="btn btn-primary">&#25628;&#32034;</button>
                        <a class="btn btn-secondary" href="Admin_JournalList.aspx?MenuId=<%=MenuId %>">&#37325;&#32622;</a>
                    </div>
                </form>
                <div class="card-body p-0">
                    <table class="table table-sm master-table">
                        <thead><tr><th style="width:70px;">ID</th><th>&#26399;&#21002;&#20449;&#24687;</th><th style="width:18%;">ISSN</th><th style="width:20%;">&#20986;&#29256;&#31038;/&#23398;&#31185;</th><th style="width:100px;">&#35770;&#25991;&#25968;</th><th style="width:100px;">&#29366;&#24577;</th><th style="width:150px;">&#26356;&#26032;&#26102;&#38388;</th><th style="width:160px;">&#25805;&#20316;</th></tr></thead>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_LiteratureCategory.aspx.cs" Inherits="Web.admin.Admin_LiteratureCategory" %>
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-6">
                                    <label class="form-label">&#20998;&#31867;&#21517;&#31216;<span>*</span></label>
                            ...
                            <div class="card-body">
                                <div class="mb-6">
                                    ...
                                    <asp:TextBox ID="name_en" runat="server" CssClass="txt form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-6">
                                    <label class="form-label">&#20998;&#31867;&#32534;&#30721;</label>
                                    <asp:TextBox ID="code" runat="server" CssClass="txt form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-6">
                                    <label class="form-label">&#29238;&#32423;&#20998;&#31867;</label>
                                    <asp:DropDownList ID="parent_id" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <tr class="hover">
                                                ...
                                                <td><%# GetParentName(Eval("parent_id")) %></td>
                                                <td><%# Function.HtmlDiscodeWeb(Eval("name_en").ToString()) %></td>
                                                <td><%# Function.HtmlDiscodeWeb(Eval("code").ToString()) %></td>
                                                <td><%# Eval("orderid") %></td>
                                    ...
                                    <asp:Panel ID="DivNull" runat="server" Visible="true">
                                        <tr>
                                            <td colspan="9" style="text-align: center;">&#26080;&#30456;&#20851;&#25968;&#25454;!</td>
                                        </tr>
                                    </asp:Panel>
                                </tbody>
                            </table>

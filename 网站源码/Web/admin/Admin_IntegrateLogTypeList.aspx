<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_IntegrateLogTypeList.aspx.cs" Inherits="Web.admin.Admin_IntegrateLogTypeList" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-3">
                        ...
                        <div class="card card-primary card-outline mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-6 ">
                                    <label class="form-label">积分类型<span>*</span></label>
                                     <asp:Label ID="IntegrateLogType_name" runat="server"></asp:Label>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="mb-6 ">
                                    <label class="form-label">对应积分<span>*</span></label>
                                    <asp:TextBox ID="num_integrate" TextMode="SingleLine" runat="server" CssClass="txt form-control" reg="^.+$" tip="不能为空"></asp:TextBox>（注意：扣除的积分为负数哦）
                                </div>
                            </div>
                            <!--end::Body-->
                            <!--begin::Footer-->
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <itemtemplate>
                                            <tr class="hover">
                                                ...
                                                <td class="textAlignC"><%#Function.HtmlDiscodeWeb(Eval("num_integrate").ToString())%></td>
                                                <td >
                                                    <%#((Eval("id").ToString()=="1"||Eval("id").ToString()=="4"||Eval("id").ToString()=="10")?"<a class=\"badge text-bg-success\" href='?Action=Edit&MenuId="+MenuId+"&ID="+Eval("id").ToString()+"&BackURL="+Function.GetEncodeURL()+"'>编辑</a>":"") %>

...
KindEditor.plugin(function(K) {
	var self = this, name = lang = self.lang(name + '.');
...
yesBtn : {
	...
	click : function(e) {
		...
		var url = [checkbox[0].checked ? self.pluginsPath + '/index.html' : '/staticimage',
...
win, doc;
		var iframe = K('<iframe class="ke-textarea" frameborder="0" src="' + self.pluginsPath + '/map.html" style="width:' + mapWidth + 'px;height:' + mapHeight + 'px;"></iframe>');
		function ready() {

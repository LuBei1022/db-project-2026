...
namespace Web.Inc
{
    public partial class uptouxiang : System.Web.UI.Page
    {
                ...
                if (count > 0)
                {
                    ...
                    if (user_list != null && user_list.id > 0)
                    {
                        try
                        {
                            ...
                            extTable.Add("upload_pic", "gif,jpg,jpeg,png");
                            int maxSize = UploadPolicy.MaxImageBytes;
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        string _imgurl = ymd + "/" + newFileName;
                                        if (user_listbll.Update("upload_pic_avatar='" + _imgurl + "'", "id=" + user_list.id))
                                        {
                                            try
                                            {
                                                if (CommonFunc.GetImgBool(user_list.upload_pic_avatar))
                                                {
                                                    Function.FileDelete(@"/A_UpLoad/upload_pic/" + user_list.upload_pic_avatar);
                                                }
                                            }
                                            ...
                                            hash["error"] = 1;
                                            hash["url"] = "/A_UpLoad/" + dirName + "/" + _imgurl;

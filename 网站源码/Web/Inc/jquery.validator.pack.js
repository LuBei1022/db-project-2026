...
$(function () {
    ...
    $("[reg],[url]:not([reg]),[tip]").hover(
	    ...
	    if ($(this).attr("url") != undefined) {
	        ...
	        validate($(this));
	    } else if ($(this).attr("strlen") != undefined) {
	        validate($(this));
	    }
	});
...
function validate(obj){
	...
	if (strlen!=undefined){
		if (objValue.length<strlen.split(",")[0] || objValue.length>strlen.split(",")[1])
		{
...
//	if (strlen.split(",")[2]=='重')
//	{
//		if (obj.prev().attr("value")!=obj.attr("value"))
//		{
//alert(obj.prev()+"/n"+obj.attr("value"));
//		  change_error_style(obj,"add");
//		  change_tip(obj,null,"remove");
//		  return false;
//		}
